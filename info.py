...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002297518503')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+CIncAcbrPjIxMjk1')  # Support group link (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002394363408")# Channels for force sub (make sure bot is admin)
